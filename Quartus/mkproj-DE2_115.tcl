#!quartus_sh -t
#
# $Id: mkproj-DE2-115.tcl,v 3.1 2011-08-22 11:53:31+09 knish Exp $
#
...
#
#source ../config.tcl
#set_parameter -name ENABLE_RUNTIME_MOD YES -to "NES:nes_i|ram2k:wram_i|altsyncram:ram_rtl_0"
#set_parameter -name INSTANCE_NAME wram -to "NES:nes_i|ram2k:wram_i|altsyncram:ram_rtl_0"
#set_parameter -name ENABLE_RUNTIME_MOD YES -to "NES:nes_i|ram2k:wram_i"
#set_parameter -name INSTANCE_NAME wram -to "NES:nes_i|ram2k:wram_i"
#set_parameter -name ENABLE_RUNTIME_MOD YES -to "NES:nes_i|ram32k:prom_i|ram_rtl_0"
#set_parameter -name INSTANCE_NAME prom -to "NES:nes_i|ram32k:prom_i|ram_rtl_0"
...
#if {$opt(reset) != ""} {
	#set_location_assignment PIN_M23 -to $opt(reset)
	#set_instance_assignment -name IO_STANDARD "2.5 V" -to $opt(reset)
...
set_global_assignment -name PROJECT_CREATION_TIME_DATE "00:23:57 AUGUST 14,2011"
...
#============================================================
set_location_assignment PIN_AD28 -to HSMC_CLKOUT_0
set_instance_assignment -name IO_STANDARD "2.5 V" -to HSMC_CLKOUT_0
set_location_assignment PIN_AH15 -to HSMC_CLKIN_0
set_instance_assignment -name IO_STANDARD "2.5 V" -to HSMC_CLKIN_0
